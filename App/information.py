...
print('''Número de elementos iniciales de catalog['artists_map']:''', nextPrime(num_artists*2))
print('''Número de elementos iniciales de catalog['artworks_map']:''', nextPrime(num_artworks*2))
